...
static Mix MIX[] = {
    { "kick",  0.78f,  0.00f, 0.00f },
    { "bass",  0.92f,  0.00f, 0.84f },
    { "clap",  1.50f,  0.06f, 0.25f },
    { "hatcl", 1.00f,  0.22f, 0.30f },
    { "hatop", 1.15f, -0.26f, 0.35f },
    { "crash", 1.30f, -0.05f, 0.30f },
    { "stab",  2.20f, -0.12f, 0.55f },
    { "lead",  1.60f,  0.10f, 0.40f },
    { "pad",   0.80f,  0.00f, 0.45f }
};
...
int main(int argc, char **argv)
{
    ...
    size_t frames = 0;
    for (int i = 0; i < N; i++) {
        if (!readWav(dir + "/layer-" + MIX[i].name + ".wav", lay[(size_t)i])) {
